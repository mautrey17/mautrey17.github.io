              ...
              <div>
                <div className="round content p-3 ">
                  ...
                  <p class="about">
                    ...
                    certificate in full stack web development through a bootcamp
                    from UNC Chapel Hill. After working on many web applications
                    from start to finish and applying UX principles to a
                    mobile-first and reactive project, I have gained the
                    technical skills necessary to thrive as a junior developer.
                    I sharpened these skills through a group project that
                    incorporated agile development, where I focused on the front
                    end of a React project management application. In addition
                    to this baseline knowledge, my years as an educator have
                    given me the soft skills of organization, leadership, and
                    efficient communication that will greatly benefit any
                    developer team. I am positioned well to provide a unique
                    perspective with how end-users interact with websites and
                    software platforms by leveraging my background as an
                    educator.
                  </p>
                </div>
              </div>
              ...
              <div className="">
                <div className="content round mb-4 p-4">
                  ...
                  <p class="">
                    ...
                    involving every aspect from the front-end to the back-end of
                    a webb application
                  </p>
                  <ul className="text-left">
                    <li>
                      Front End: HTML, CSS, Bootstrap, Bulma, JavaScript, JQuery
                    </li>
                    <li>
            ...
            <div className="col-md-9">
              <div className="">
                <div className="content round mb-4 p-4">
                  ...
                  <p class="mt-4 about">
                    If you would like to learn more about my work, you can find
                    my:{" "}
                  </p>
                  <div className="row">
